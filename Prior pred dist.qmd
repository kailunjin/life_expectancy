...
We will use predictor: percentage_expenditure, GDP, Schooling, Status, Year
...
zlf_data <- lf_data |>
  ...
  mutate(
    ...
    Year = factor(Year),
    Year_ix = as.numeric(Year))|>
  # drop any rows with NAs
  select(percentage_expenditure_scaled, GDP_scaled, Schooling_scaled, Status, Status_ix, Year, Year_ix)|>
  drop_na()
```
